...
function updateDeckCounts() {
    var playerDeckCount = document.querySelector('.cards:not(.reverse) #deck-count');
    var machineDeckCount = document.querySelector('.cards.reverse #deck-count');
    if (playerDeckCount) {
        playerDeckCount.textContent = "".concat(villainsPlayer.length);
    }
    if (machineDeckCount) {
        machineDeckCount.textContent = "".concat(villainsMachine.length);
    }
}
// Função para vitória
function playerWin() {
